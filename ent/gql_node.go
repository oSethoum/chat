...
func (gr *Group) Node(ctx context.Context) (node *Node, err error) {
	...
	err = gr.QueryUserGroups().
		Select(usergroup.FieldID).
...
func (m *Message) Node(ctx context.Context) (node *Node, err error) {
	...
	var buf []byte
	if buf, err = json.Marshal(m.SentAt); err != nil {
		return nil, err
	}
	node.Fields[0] = &Field{
		Type:  "time.Time",
	...
	if buf, err = json.Marshal(m.Message); err != nil {
		return nil, err
	}
	node.Fields[1] = &Field{
		Type:  "string",
...
func (ug *UserGroup) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     ug.ID,
		Type:   "UserGroup",
		Fields: make([]*Field, 1),
	...
	var buf []byte
	if buf, err = json.Marshal(ug.CreatedAt); err != nil {
		return nil, err
	}
	node.Fields[0] = &Field{
		Type:  "time.Time",
