...
func (gu *GroupUpdate) AddUserGroups(u ...*UserGroup) *GroupUpdate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
...
func (gu *GroupUpdate) ClearUserGroups() *GroupUpdate {
	gu.mutation.ClearUserGroups()
	return gu
}
...
func (gu *GroupUpdate) RemoveUserGroups(u ...*UserGroup) *GroupUpdate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
...
func (gu *GroupUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if gu.mutation.UserGroupsCleared() {
	...
	if nodes := gu.mutation.RemovedUserGroupsIDs(); len(nodes) > 0 && !gu.mutation.UserGroupsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   group.UserGroupsTable,
	...
	if nodes := gu.mutation.UserGroupsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   group.UserGroupsTable,
...
// AddUserGroups adds the "userGroups" edges to the UserGroup entity.
func (guo *GroupUpdateOne) AddUserGroups(u ...*UserGroup) *GroupUpdateOne {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
...
// ClearUserGroups clears all "userGroups" edges to the UserGroup entity.
func (guo *GroupUpdateOne) ClearUserGroups() *GroupUpdateOne {
	guo.mutation.ClearUserGroups()
	return guo
}
...
// RemoveUserGroups removes "userGroups" edges to UserGroup entities.
func (guo *GroupUpdateOne) RemoveUserGroups(u ...*UserGroup) *GroupUpdateOne {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
...
func (guo *GroupUpdateOne) sqlSave(ctx context.Context) (_node *Group, err error) {
	...
	if guo.mutation.UserGroupsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   group.UserGroupsTable,
	...
	if nodes := guo.mutation.RemovedUserGroupsIDs(); len(nodes) > 0 && !guo.mutation.UserGroupsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   group.UserGroupsTable,
	...
	if nodes := guo.mutation.UserGroupsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   group.UserGroupsTable,
