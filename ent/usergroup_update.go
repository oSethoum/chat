...
func (ugu *UserGroupUpdate) SetGroupID(id int) *UserGroupUpdate {
	ugu.mutation.SetGroupID(id)
	return ugu
}

// SetNillableGroupID sets the "group" edge to the Group entity by ID if the given value is not nil.
func (ugu *UserGroupUpdate) SetNillableGroupID(id *int) *UserGroupUpdate {
	if id != nil {
		ugu = ugu.SetGroupID(*id)
	}
	return ugu
}
...
func (ugu *UserGroupUpdate) SetUserID(id int) *UserGroupUpdate {
	ugu.mutation.SetUserID(id)
	return ugu
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (ugu *UserGroupUpdate) SetNillableUserID(id *int) *UserGroupUpdate {
	if id != nil {
		ugu = ugu.SetUserID(*id)
	}
	return ugu
}
...
// SetGroupID sets the "group" edge to the Group entity by ID.
func (uguo *UserGroupUpdateOne) SetGroupID(id int) *UserGroupUpdateOne {
	uguo.mutation.SetGroupID(id)
	return uguo
}

// SetNillableGroupID sets the "group" edge to the Group entity by ID if the given value is not nil.
func (uguo *UserGroupUpdateOne) SetNillableGroupID(id *int) *UserGroupUpdateOne {
	if id != nil {
		uguo = uguo.SetGroupID(*id)
	}
	return uguo
}
...
// SetUserID sets the "user" edge to the User entity by ID.
func (uguo *UserGroupUpdateOne) SetUserID(id int) *UserGroupUpdateOne {
	uguo.mutation.SetUserID(id)
	return uguo
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (uguo *UserGroupUpdateOne) SetNillableUserID(id *int) *UserGroupUpdateOne {
	if id != nil {
		uguo = uguo.SetUserID(*id)
	}
	return uguo
}
